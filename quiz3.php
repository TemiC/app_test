		...
		<div id="container">
			...
			<?php 
				...
				if (!$dbhandle){
					...
					$i= 0;
					$request =  $dbhandle->query('SELECT id, question, rep1, rep2, rep3, rep_juste, images FROM qcm3 ORDER BY RANDOM() LIMIT 2' );
			...
			?>
				...
				<FORM name="quiz" method="post" action="identity.php" enctype="multipart/form-data">
							<h2> <?php 
								$i++;
