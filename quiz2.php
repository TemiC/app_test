	...
	<meta http-equiv="content-language" content="fr" />
		...
		<div id="container">
			...
			<?php 
				...
				$nbRecord = pg_query($connexion,"SELECT * FROM quizz.qcm2");  //select all the datas comming from the DB
				$nbRecord = pg_num_rows($nbRecord);  //nb insertions in the DB
				$request = pg_query($connexion,"SELECT id, question, rep1, rep2, rep3, rep_juste, images FROM quizz.qcm2 ORDER BY RANDOM() LIMIT $nbQuestions");
				$i = 0; 
